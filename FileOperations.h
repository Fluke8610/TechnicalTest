...
public:
	...
	// INI File
	static bool ParseIniFileContent(Logger* pLogger, const CString& iniFileStr, CMapStringToPtr* initMapping, bool flgDirsOnly, bool flgDontRecurse, bool flgDirsAlso);
